/* ============================================================
   SITE CONTENT — edit this file to change what appears on the site.
   This is the ONLY file you need to touch to update text, images,
   links, or to turn a whole section on/off. The page (render.js)
   reads this object and builds the site from it automatically.

   See TEMPLATE-GUIDE.md for a plain-English walkthrough of every
   field below.
   ============================================================ */
...
window.SITE_CONTENT = {
  ...
  // ---------------------------------------------------------
  // PERSON — who this site is about
  // ---------------------------------------------------------
  person: {
    name: "Kunal Shah",          // used in the nav logo and footer
  ...
  // ---------------------------------------------------------
  // SECTIONS — turn sections on/off and control nav order.
  // Only sections with enabled:true are shown. The order of
  // this list controls the order they appear on the page AND
  // in the navigation menu. "navLabel" is what shows in the
  // menu — leave it out (or set to null) to leave a section
  // out of the nav menu while still showing it on the page.
  // ---------------------------------------------------------
  sections: [
  ...
  // ---------------------------------------------------------
  // HERO — the full-screen intro at the top of the page
  // ---------------------------------------------------------
  hero: {
    eyebrow: "I fly. I build. I create.",
    headlineLines: ["Building ideas", "that take flight."],
    buttons: [
      { label: "Explore my work", href: "#work", style: "primary" },
      { label: "Let's connect", href: "#contact", style: "secondary" }
    ],
    background: {
      type: "video",                       // "video" or "image"
      video: "images/hero-video.mp4",
      poster: "images/hero-studio.jpg",
      posterAlt: "Kunal Shah, studio portrait"
    },
    showTopoLines: true                     // faint decorative contour lines over the hero
  },
  ...
  about: {
    ...
    now: {
      ...
      nextText: "Continuing to fly, build, create, and explore new opportunities across aviation, entrepreneurship, technology, and creative business."
    }
  },

  // ---------------------------------------------------------
  // JOURNEY — a "training / milestones" section. For Kunal this
  // is Aviation, but the same layout works for any field: a
  // culinary training path, an education timeline, a design
  // career path, etc. Just change the text.
  // ---------------------------------------------------------
  journey: {
    title: "Aviation",
    intro: [
    ...
    // Shown on the HOMEPAGE only, right after the timeline above — a
    // short prompt + link to the full Aviation page (aviation.html),
    // which has the rest: aircraft & simulator, flight skills, core
    // skills, and the closing statement. Keeps the homepage shorter
    // without removing Aviation from it. Set to null to hide this and
    // just show nothing after the timeline.
    readMore: {
    ...
    // Everything from here down (gallery, skillGroups, closing) is shown
    // in full on aviation.html — the homepage only shows the intro and
    // timeline above, plus the "readMore" link.
    gallery: {
  ...
  // ---------------------------------------------------------
  // SKILLS — a standalone skills section (off by default here,
  // since Kunal's flight/core skills already live in "journey").
  // Turn this on for people who need a simple skills section
  // instead (designers, developers, etc).
  // ---------------------------------------------------------
  skills: {
    heading: "Skills",
    intro: "",
  ...
  // ---------------------------------------------------------
  // WORK — selected projects / ventures
  // ---------------------------------------------------------
  work: {
    heading: "Selected work",
    intro: "Across both ventures my role is Founder / Brand &amp; Creative Director. I identify the opportunity, define what the brand should become, and bring the right people and tools together to build it.",
    coreAreas: {
      title: "Core Areas",
      items: ["Brand Direction", "Creative Direction", "Product Positioning", "E-Commerce Strategy", "Content &amp; Social", "Campaign Development", "Meta Ads", "SEO &amp; Digital Growth"]
    },
    items: [
      {
        year: "2026",
        ...
        capabilities: {
          ...
          items: ["Brand Direction", "Creative Direction", "Product Positioning", "Product Storytelling", "E-Commerce Strategy", "Campaign Development", "Content &amp; Social", "Meta Ads", "SEO &amp; Digital Growth", "Customer Experience"]
        },
  ...
  // ---------------------------------------------------------
  // SERVICES — off by default. Turn on for freelancers,
  // consultants, photographers, etc. who offer specific services.
  // ---------------------------------------------------------
  services: {
    heading: "Services",
    intro: "",
  ...
  contact: {
    ...
    // Optional: link to a resume/CV file or page. Leave as null to hide it.
    resumeUrl: null,
